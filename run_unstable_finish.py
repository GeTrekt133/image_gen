#!/usr/bin/env python3
"""unStable Revolution + finish (realistic LoRA -> FaceDetailer -> 2K refine), ABCD по всему NSFW-сету.
1 сабмит = 4 стадии. -> /workspace/gallery/unstable_finish/"""
...
OUT="/workspace/gallery/unstable_finish"; os.makedirs(OUT,exist_ok=True)
WF="/workspace/wf_unstable_finish.json"
STAGES={"52":"A_unstable","72":"B_facedetailer","86":"C_final"}
